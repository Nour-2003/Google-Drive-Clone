...
class FolderInspectPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final folders = children.where((item) => item['isFolder'] == true).toList();
    final files = children.where((item) => item['isFolder'] == false).toList();
                      ...
                      Row(
                        children: [
                          const Padding(
                            ...
                            child: Icon(Icons.folder, size: 40, color: Color(0xff111827)),
                          ),
                          Expanded(
                            child: Text(
                              folder['name'],
